...
# module references:
# dsp_send, dsp_send, serial_pipe, serial_pipe, serial_pipe
...
stfc_tech:user:udp_core_eval:1.0\
...
proc create_root_design { parentCell } {
  ...
  set udp_axis_m_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 udp_axis_m_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {322265625} \
   ] $udp_axis_m_0

  set udp_axis_m_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 udp_axis_m_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {322265625} \
   ] $udp_axis_m_1

  set udp_axis_s_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 udp_axis_s_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {322265625} \
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
  ...
  set udp_axis_s_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 udp_axis_s_1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {322265625} \
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_0_1] [get_bd_intf_ports S00_AXI_0] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net udp_axis_s_0_1 [get_bd_intf_ports udp_axis_s_0] [get_bd_intf_pins udp_core_eval_0/udp_axis_s]
  connect_bd_intf_net -intf_net udp_axis_s_1_1 [get_bd_intf_ports udp_axis_s_1] [get_bd_intf_pins udp_core_eval_1/udp_axis_s]
  ...
  connect_bd_intf_net -intf_net udp_core_eval_0_udp_axis_m [get_bd_intf_ports udp_axis_m_0] [get_bd_intf_pins udp_core_eval_0/udp_axis_m]
  ...
  connect_bd_intf_net -intf_net udp_core_eval_1_udp_axis_m [get_bd_intf_ports udp_axis_m_1] [get_bd_intf_pins udp_core_eval_1/udp_axis_m]
  ...
  connect_bd_net -net Net1 [get_bd_pins serial_pipe_0/serial_out] [get_bd_pins udp_core_eval_0/rx_axis_s_rst] [get_bd_pins udp_core_eval_0/tx_axis_m_rst]
  connect_bd_net -net Net2 [get_bd_pins serial_pipe_0/en] [get_bd_pins serial_pipe_0/rst_s_n] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net axi4lite_aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins cmac_usplus_0/drp_clk] [get_bd_pins cmac_usplus_0/init_clk] [get_bd_pins cmac_usplus_1/drp_clk] [get_bd_pins cmac_usplus_1/init_clk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins udp_core_eval_0/axi4lite_aclk] [get_bd_pins udp_core_eval_1/axi4lite_aclk]
  connect_bd_net -net axi4lite_aresetn_0_1 [get_bd_ports locked] [get_bd_pins ila_0/probe6] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins udp_core_eval_0/axi4lite_aresetn] [get_bd_pins udp_core_eval_1/axi4lite_aresetn] [get_bd_pins util_vector_logic_4/Op1]
  ...
  connect_bd_net -net serial_pipe_1_serial_out [get_bd_pins serial_pipe_1/serial_out] [get_bd_pins udp_core_eval_1/rx_axis_s_rst] [get_bd_pins udp_core_eval_1/tx_axis_m_rst]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs udp_core_eval_0/axi4lite/reg0] -force
  assign_bd_address -offset 0x00002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs udp_core_eval_1/axi4lite/reg0] -force

; ModuleID = '/.aux_mnt/fpgdeva/casperlibs/vitis/workspace/rtl_u280_kernel/vivado_rtl_kernel/rtl_kernel_wizard_1_ex/imports/hls/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_rtl_kernel_wizard_1_ir(%"class.hls::stream"* %mac0_m, %"class.hls::stream"* %mac0_s, %"class.hls::stream"* %mac1_m, %"class.hls::stream"* %mac1_s) local_unnamed_addr #0 {
entry:
  %mac0_m_copy = alloca %"class.hls::stream", align 512
  %mac0_s_copy = alloca %"class.hls::stream", align 512
  %mac1_m_copy = alloca %"class.hls::stream", align 512
  %mac1_s_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %mac0_m, %"class.hls::stream"* nonnull align 512 %mac0_m_copy, %"class.hls::stream"* %mac0_s, %"class.hls::stream"* nonnull align 512 %mac0_s_copy, %"class.hls::stream"* %mac1_m, %"class.hls::stream"* nonnull align 512 %mac1_m_copy, %"class.hls::stream"* %mac1_s, %"class.hls::stream"* nonnull align 512 %mac1_s_copy)
  call void @apatb_rtl_kernel_wizard_1_hw(%"class.hls::stream"* %mac0_m_copy, %"class.hls::stream"* %mac0_s_copy, %"class.hls::stream"* %mac1_m_copy, %"class.hls::stream"* %mac1_s_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %mac0_m, %"class.hls::stream"* nonnull align 512 %mac0_m_copy, %"class.hls::stream"* %mac0_s, %"class.hls::stream"* nonnull align 512 %mac0_s_copy, %"class.hls::stream"* %mac1_m, %"class.hls::stream"* nonnull align 512 %mac1_m_copy, %"class.hls::stream"* %mac1_s, %"class.hls::stream"* nonnull align 512 %mac1_s_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.0(%struct.ap_uint.0* noalias nocapture align 64, %struct.ap_uint.0* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.1(%struct.ap_int_base.1* noalias nocapture align 64, %struct.ap_int_base.1* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.2(%struct.ssdm_int.2* noalias nocapture align 64, %struct.ssdm_int.2* noalias nocapture) unnamed_addr #3 {
entry:
...
declare void @apatb_rtl_kernel_wizard_1_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @rtl_kernel_wizard_1_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  ...
  call void @rtl_kernel_wizard_1_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2, %"class.hls::stream"* %3)
...
declare void @rtl_kernel_wizard_1_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

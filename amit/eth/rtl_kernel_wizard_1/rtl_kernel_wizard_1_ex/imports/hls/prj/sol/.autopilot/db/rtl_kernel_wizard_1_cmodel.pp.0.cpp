# 1 "../rtl_kernel_wizard_1_cmodel.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../rtl_kernel_wizard_1_cmodel.cpp" 2
# 17 "../rtl_kernel_wizard_1_cmodel.cpp"
...
# 18 "../rtl_kernel_wizard_1_cmodel.cpp" 2
# 1 "/opt/Xilinx/Vitis_HLS/2020.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdbool.h" 1 3
# 19 "../rtl_kernel_wizard_1_cmodel.cpp" 2
# 1 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_half.h" 1
# 57 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_half.h"
typedef __fp16 half;
# 20 "../rtl_kernel_wizard_1_cmodel.cpp" 2
...
# 21 "../rtl_kernel_wizard_1_cmodel.cpp" 2
...
void read_stream (
   hls::stream< qdma_axis<INPUT_BITS,0,0,0> >& s_axis,
...
void write_stream (
   qdma_axis<ACC_BITS,0,0,0> &acc,
   hls::stream< qdma_axis<OUTPUT_BITS,0,0,0> >& m_axis
) {
...
void parallel_adder ( qdma_axis<ACC_BITS,0,0,0> &acc, unsigned int adder_width) {
   VITIS_LOOP_80_1: for (unsigned int i=0; i < ACC_BITS; i+= adder_width) {
...
extern "C" __attribute__((sdx_kernel("rtl_kernel_wizard_1", 0))) void rtl_kernel_wizard_1 (
...
#pragma HLS TOP name=rtl_kernel_wizard_1
# 113 "../rtl_kernel_wizard_1_cmodel.cpp"

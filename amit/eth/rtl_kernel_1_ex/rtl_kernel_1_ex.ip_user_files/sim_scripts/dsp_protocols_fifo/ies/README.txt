...
#
# Generated by export_simulation on Tue Oct 20 16:51:28 CEST 2020
#
################################################################################
...
'-reset_run' switch to the './dsp_protocols_fifo.sh' script.

./dsp_protocols_fifo.sh -reset_run
...
./dsp_protocols_fifo.sh -noclean_files

For more information on the script, please type './dsp_protocols_fifo.sh -help'.

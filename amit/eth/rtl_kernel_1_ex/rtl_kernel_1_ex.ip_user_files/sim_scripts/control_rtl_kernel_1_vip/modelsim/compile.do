...
vlog -work xilinx_vip -64 -incr -sv -L axi_vip_v1_1_7 -L xilinx_vip "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
...
vlog -work xpm -64 -incr -sv -L axi_vip_v1_1_7 -L xilinx_vip "+incdir+../../../ipstatic/hdl" "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -sv -L axi_vip_v1_1_7 -L xilinx_vip "+incdir+../../../ipstatic/hdl" "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
"../../../../rtl_kernel_1_ex.srcs/sources_1/ip/control_rtl_kernel_1_vip/sim/control_rtl_kernel_1_vip_pkg.sv" \

vlog -work axi_vip_v1_1_7 -64 -incr -sv -L axi_vip_v1_1_7 -L xilinx_vip "+incdir+../../../ipstatic/hdl" "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
"../../../ipstatic/hdl/axi_vip_v1_1_vl_rfs.sv" \

vlog -work xil_defaultlib -64 -incr -sv -L axi_vip_v1_1_7 -L xilinx_vip "+incdir+../../../ipstatic/hdl" "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
"../../../../rtl_kernel_1_ex.srcs/sources_1/ip/control_rtl_kernel_1_vip/sim/control_rtl_kernel_1_vip.sv" \

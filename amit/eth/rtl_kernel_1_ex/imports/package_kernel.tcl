...
proc package_project {path_to_packaged kernel_vendor kernel_library kernel_name} {
  ...
  set_property physical_name refclk_gt_p [ipx::get_port_maps CLK_P -of_objects [ipx::get_bus_interfaces gt -of_objects [::ipx::current_core]]]
  ipx::add_port_map CLK_N [ipx::get_bus_interfaces gt -of_objects [::ipx::current_core]]
  set_property physical_name refclk_gt_n [ipx::get_port_maps CLK_N -of_objects [ipx::get_bus_interfaces gt -of_objects [::ipx::current_core]]]
...
proc set_gt {path} {
  set core [ipx::unload_core /.aux_mnt/fpgdeva/casperlibs/workspace/rtl_2/vivado_rtl_kernel/rtl_kernel_1_ex/rtl_kernel_1/component.xml]
  puts "Starting gt mapping"
  puts $core
}
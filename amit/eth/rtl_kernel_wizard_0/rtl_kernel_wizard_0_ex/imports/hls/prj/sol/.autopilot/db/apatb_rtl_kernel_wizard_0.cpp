...
// wrapc file define:
#define AUTOTB_TVIN_A "../tv/cdatafile/c.rtl_kernel_wizard_0.autotvin_A.dat"
#define AUTOTB_TVOUT_A "../tv/cdatafile/c.rtl_kernel_wizard_0.autotvout_A.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_A "../tv/rtldatafile/rtl.rtl_kernel_wizard_0.autotvout_A.dat"
// tvout file define:
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+0] = A_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+1] = A_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+2] = A_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+3] = A_pc_buffer[i].range(255,192).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+4] = A_pc_buffer[i].range(319,256).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+5] = A_pc_buffer[i].range(383,320).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+6] = A_pc_buffer[i].range(447,384).to_int64();
((long long*)__xlx_apatb_param_axi00_ptr0)[j*8+7] = A_pc_buffer[i].range(511,448).to_int64();
}}}
        } // end transaction
      } // end file is good

...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=31,numReposBlks=31,numNonXlnxBlks=4,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (ACLK_EN_0,
    ARESET_0,
    S00_AXI_0_araddr,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_BUSIF S00_AXI_0, CLK_DOMAIN design_1_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input aclk_0;
  input ap_done_0;
  input ap_idle_0;
  input ap_ready_0;
  output ap_start_0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_clk0 CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sys_clk0, CAN_DEBUG false, FREQ_HZ 100000000" *) input sys_clk0_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_clk0 CLK_P" *) input sys_clk0_clk_p;
  ...
  wire [1:0]smartconnect_1_M01_AXI_ARID;
  ...
  wire [1:0]smartconnect_1_M01_AXI_AWID;
  ...
  wire [1:0]smartconnect_1_M01_AXI_BID;
  ...
  wire [1:0]smartconnect_1_M01_AXI_RID;
  ...
  assign CLK_IN1_D_0_1_CLK_N = sys_clk0_clk_n;
  assign CLK_IN1_D_0_1_CLK_P = sys_clk0_clk_p;
  ...
  design_1_dsp_send_0_0 dsp_send_0
       (.clk(cmac_usplus_2_gt_txusrclk2),
        .core_xeset(dsp_send_2_core_reset),
  ...
  design_1_dsp_send_1_0 dsp_send_1
       (.clk(cmac_usplus_1_gt_txusrclk2),
        .core_xeset(dsp_send_0_core_reset),
  ...
  design_1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(dsp_send_2_core_reset),
        .mb_debug_sys_rst(1'b0),
        .peripheral_reset(proc_sys_reset_0_peripheral_reset),
        .slowest_sync_clk(init_clk_0));
  design_1_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(dsp_send_0_core_reset),
        .mb_debug_sys_rst(1'b0),
